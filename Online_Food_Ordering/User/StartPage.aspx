...
<body>
    <form id="form1" runat="server">
        ...
        <p>
        <asp:ImageButton ID="ImgBtnStart" runat="server" Height="113px" Width="161px" ImageUrl="~/Image/startbutton.png"  style="margin-top: 306px; margin-left: 621px;" OnClick="ImgBtnStart_Click"/>
        </p>
        <p>
            &nbsp;</p>
